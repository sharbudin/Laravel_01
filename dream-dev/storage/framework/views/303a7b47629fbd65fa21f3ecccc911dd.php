...
<body>
    <div class="container-fluid reg-cont" style="padding: 5vh;width:100%;height:100%">
        <form method="POST" action="<?php echo e(url('OTPverify')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="row justify-content-center">
                <div class="col-sm-3">
                    <div class="row">
                        <div class="input-group">
                            <input type="hidden" name="ResetCodeMail" value=<?php echo e(Session::get('checkMail')); ?>>
...
<?php echo $__env->make('partials.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\Laravel_01\dream-dev\resources\views/verifyOtp.blade.php ENDPATH**/ ?>