        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            <?php if(Route::has('login')): ?>
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                    ...
                    <?php else: ?>
                        <?php if((Session::has('ID'))): ?>
                            <a href="<?php echo e(route('logout')); ?>" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log Out</a>
                        <?php endif; ?>
...
<?php /**PATH /home/developer/Laravel/ajith/dream-dev/resources/views/welcome.blade.php ENDPATH**/ ?>