...
class DashboardController extends Controller {
	...
	public function fetchAll() {
		...
		if ($emps->count() > 0) {
			...
			foreach ($emps as $emp) {
                ...
                <td>' . $emp->phone . '</td>
                <td>
                  <a href="/print/'.$emp->id.'" id="' . $emp->id . '" target="_blank" class="text-warning mx-1 printIcon"><i class="bi bi-printer h4"></i></a>
    ...
    public function print($id) {
        ...
        $pdf = PDF::loadView('print', $print_data);
        return $pdf->download($data->first_name."_".$data->id.'.pdf');
	}
