...
@section('Title','Register @ Dream Dev ')
            ...
            <form method="POST" action="{{url('registerUser')}}">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <label for="idLabel" class="form-label"><span
                                class="span-required">***</span>{{Session::get('message')}}<span class="span-required">***</span></label>
                        @endif
                    </div>
                </div>
                @if (count($errors) > 0)
                    @foreach ($errors->all() as $error)
                        <div class="row justify-content-center">
                            <div class="col-lg-6">
                                <label for="idLabel" class="form-label"><span
                                    class="span-required">***</span>{{ $error }}<span class="span-required">***</span></label>
                            </div>
                        </div>
                    @endforeach
                @endif
                <div class="row justify-content-center">
                    <div class="col-lg-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" autocomplete="off" value="{{old('id')}}" name="id" id="id"
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" autocomplete="off" value="{{old('username')}}" name="username"
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3">
                        <label for="firstnameLabel" class="form-label">First name<span
                                class="span-required">*</span></label>
                        <input type="text" class="form-control" autocomplete="off" value="{{old('firstname')}}" name="firstname" id="firstname"
                            required>
                    </div>
                    <div class="col-lg-3">
                        <label for="lastnameLabel" class="form-label">Last name</label>
                        <input type="text" class="form-control" autocomplete="off" value="{{old('lastname')}}" name="lastname" id="lastname">
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3">
                        ...
                        <input type="date" class="form-control" autocomplete="off" value="{{old('dob')}}" name="dob" id="dob" required>
                    </div>
                    <div class="col-lg-3">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-3">
                        <label for="emailLabel" class="form-label">Email ID<span
                                class="span-required">*</span></label>
                        <div class="input-group">
                            <input type="text" class="form-control" autocomplete="off" value="{{old('email')}}" name="email" id="email"
                                aria-describedby="inputGroupPrepend2" required>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control" autocomplete="off" value="{{old('phone')}}" name="phone" id="phone"
                                aria-describedby="inputGroupPrepend2" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3">
                        <label for="qualificationLabel" class="form-label">Qualification<span
                                class="span-required">*</span></label>
                        <div class="input-group">
                            <input class="form-control" list="EduOption" autocomplete="off" value="{{old('qualification')}}" name="qualification" id="qualification"
                                placeholder="Search" required>
                            <datalist id="EduOption">
                                @foreach ($studies as $EudOption)
                                <option value="{{$EudOption->qualification}}">
                                    @endforeach
                    ...
                    <div class="col-lg-3">
                        ...
                        <div>
                            <select name="skill-multi-select[]" autocomplete="off" class="form-control" id="multiple-checkboxes" value="{{old('skill-multi-select[]')}}" multiple="multiple">
                    ...
                    <div class="col-lg-3">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <textarea class="form-control" autocomplete="off" value="{{old('address')}}" name="address" id="address"
                                    rows="4"></textarea>
                            </div>
                            <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <select class="form-control" value="{{old('country')}}" name="country" id="country-dropdown" required>
                            ...
                            <div class="row">
                                ...
                                <select class="form-control" value="{{old('state')}}" name="state" id="state-dropdown" required>
                                </select>
                            </div>
                            <div class="row">
                                <label for="city">City<span class="span-required">*</span></label>
                                <select class="form-control" value="{{old('city')}}" name="city" id="city-dropdown" required>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="{{old('checkbox')}} name="checkbox" value="" id="checkbox"
                                required>
...
@include('partials.registerHelper')
